...
Runs JSON and shell validation, Python tests, and the five Qt unit suites.
...
dmx_run_logged targetradarwidget_qttest run_qt_test targetradarwidget_tests.pro targetradarwidget_tests
